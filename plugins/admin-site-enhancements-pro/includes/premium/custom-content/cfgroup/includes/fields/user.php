...
class cfgroup_user extends cfgroup_field
{
    ...
    ?>
        ...
        <?php foreach ( $available_users as $user ) : ?>
            ...
            <div rel="<?php echo $user->ID; ?>"<?php echo $class; ?>><?php echo apply_filters( 'cfgroup_user_display', $user->user_login, $user->ID, $field ); ?></div>
        <?php endforeach; ?>
        </div>

        <div class="selected_posts post_list">
        <?php foreach ( $selected_users as $user ) : ?>
            <div rel="<?php echo $user->ID; ?>"><span class="remove"></span><?php echo apply_filters( 'cfgroup_user_display', $user->user_login, $user->ID, $field ); ?></div>
        <?php endforeach; ?>
        </div>
        <div class="clear"></div>
