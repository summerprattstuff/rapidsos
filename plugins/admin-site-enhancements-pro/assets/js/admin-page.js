(function( $ ) {
   ...
   $(document).ready( function() {
      ...
      /*! <fs_premium_only> */
      $('.maintenance-page-background-image').appendTo('.fields-utilities .maintenance-mode .asenha-subfields');
      ...
      /*! <fs_premium_only> */
      // Maintenance => Check if 'Image' or 'Color' is chosen/clicked and show/hide the corresponding select field      
      if ( $('input[name="admin_site_enhancements[maintenance_page_background]"]:checked').val() == 'image' ) {
