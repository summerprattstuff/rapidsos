...
class Settings_Sanitization {
	...
	function sanitize_for_options( $options ) {
		...
		global $wp_roles, $asenha_public_post_types, $asenha_gutenberg_post_types, $asenha_revisions_post_types, $active_plugin_slugs;
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			if ( ! isset( $options['custom_frontend_css_priority'] ) ) $options['custom_frontend_css_priority'] = '';
			$options['custom_frontend_css_priority'] = ( isset( $options['custom_frontend_css_priority'] ) ) ? $options['custom_frontend_css_priority'] : 10;        	
        }
